...
{
    Task<Song?> GetByPathAsync(Uri songPath, CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    ValueTask<OperationResult> ReplaceToLibraryAsync(Uri replacingFile, Uri libraryFile, CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    ValueTask<OperationResult> MoveToLibraryAsync(Uri sourceFile, Uri libraryFile, CancellationToken cancellationToken = default);
