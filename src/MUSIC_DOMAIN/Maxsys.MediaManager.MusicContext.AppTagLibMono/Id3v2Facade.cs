...
public class Id3v2Facade
{
    ...
    public int? TrackNumber
    {
        ...
        set => _tags.Track = value is null ? 0 : (uint)value.Value;
    }

    public int? Year
    {
        get => _tags.Year == 0 ? null : (int?)_tags.Year;
        set => _tags.Year = value is null ? 0 : (uint)value.Value;
    }

    public string? Comments
    {
        get => string.IsNullOrWhiteSpace(_tags.Subtitle) ? null : _tags.Subtitle;
        set
        {
            // WARNING Problemas em passar nulo aqui?
            _tags.Comment = value;
    ...
    {
        get => string.IsNullOrWhiteSpace(_tags.Lyrics) ? null : _tags.Lyrics;
