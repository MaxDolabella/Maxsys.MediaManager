...
namespace Maxsys.MediaManager.MusicContext.Infra.DataExporter.SQLValuesScript.Scripts
{
    public class AlbumScripts : InsertScriptBase<Album>
    {
        ...
        {
            return $"({Value(obj.Id)}, {Value(obj.Directory.AbsolutePath)}, {Value(obj.Name)}, {Value(obj.Year)}, {Value(obj.Genre)}, {Value((byte)obj.AlbumType)}, {Value(obj.AlbumCover)}, {Value(obj.ArtistId)})";
        }
    }
}